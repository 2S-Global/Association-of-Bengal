  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11 ring-2 ring-white/20">
          <Image
        ...
        <span className="mr-1 block font-medium text-theme-sm text-white">
        ...
        <ul className="flex flex-col gap-1 border-b border-gray-200 pb-3 pt-4 dark:border-gray-800">
          <li>
            <DropdownItem
              ...
              tag="a"
              href="/admin/change-password"   // ← update this path if needed
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M12 2.5C9.51472 2.5 7.5 4.51472 7.5 7V9.5H6.5C5.11929 9.5 4 10.6193 4 12V18.5C4 19.8807 5.11929 21 6.5 21H17.5C18.8807 21 20 19.8807 20 18.5V12C20 10.6193 18.8807 9.5 17.5 9.5H16.5V7C16.5 4.51472 14.4853 2.5 12 2.5ZM15 9.5V7C15 5.34315 13.6569 4 12 4C10.3431 4 9 5.34315 9 7V9.5H15ZM6.5 11H17.5C18.0523 11 18.5 11.4477 18.5 12V18.5C18.5 19.0523 18.0523 19.5 17.5 19.5H6.5C5.94772 19.5 5.5 19.0523 5.5 18.5V12C5.5 11.4477 5.94772 11 6.5 11ZM12 14C11.4477 14 11 14.4477 11 15V16.5C11 17.0523 11.4477 17.5 12 17.5C12.5523 17.5 13 17.0523 13 16.5V15C13 14.4477 12.5523 14 12 14Z"
                  fill=""
                />
              </svg>
              Change password
