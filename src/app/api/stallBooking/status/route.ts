...
//     // 2. Create the history record entry
//     const historyEntry = {
//       action: status,
...
//     // 3. Update status, amount, remark AND push to history array atomically
//     const updatedApp = await Application.findByIdAndUpdate(
//       applicationId,
//       { 
//         status, 
//         amount, 
//         remark,
//         $push: { history: historyEntry } // 👉 Appends this action to the audit history timeline
//       },
//       { new: true }
//     );
...
//     // 4. Trigger the dedicated email function with the correct arguments
//     if (status === "ACCEPTED") {
//       await sendAcceptanceEmail(
//         updatedApp.participant_email, 
//         updatedApp.participant_name, 
...
export async function POST(req: Request) {
  try {
    ...
    // 4. Trigger the dedicated email function with fair_title passed dynamically
    const eventFairTitle = updatedApp.fair_title || "International Kolkata Book Fair 2026";
