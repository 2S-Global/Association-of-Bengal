...
//               Your membership is active and ready to use! Download our mobile app to view and save your digital ID card so you can access it anytime.
//             </p>
//           </div>
...
export default function MyProfilePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 pb-16 font-['Libre_Franklin',sans-serif]">
      ...
      {/* Main Split Layout Grid - Structured with equal column stretching */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
        
        {/* Left Sidebar Card: Profile Summary */}
        <div className="bg-white p-6 sm:p-8 rounded-3xl border border-[#e0bfbf]/60 shadow-sm flex flex-col justify-between items-center lg:items-start text-center lg:text-left">
          ...
          {/* Digital ID Card Notice */}
          <div className="w-full bg-[#fbf2ed] border border-[#e0bfbf]/70 rounded-2xl p-4 text-left space-y-2 mt-6">
            <div className="flex items-center gap-2 text-[#570013]">
              <Sparkles className="w-4 h-4 text-[#775a19] shrink-0" />
              <h4 className="text-xs font-extrabold uppercase tracking-wider">Digital Member ID Card</h4>
            </div>
        ...
        <div className="lg:col-span-2 flex flex-col">
          ...
          {activeTab === "profile" ? (
            <div className="bg-white p-6 sm:p-8 rounded-3xl border border-[#e0bfbf]/60 shadow-sm flex flex-col justify-between h-full animate-in fade-in duration-200">
