  ...
  return (
    <div className="min-h-screen bg-[#fff8f5] flex font-['Libre_Franklin',sans-serif]">
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-72 bg-white border-r border-[#e0bfbf]/60 flex flex-col transition-transform duration-300 shadow-xl md:shadow-none md:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
        ...
        {/* Sidebar Header - Adjusted height and flex alignment to prevent vertical squishing */}
        <div className="h-20 flex items-center px-6 border-b border-[#e0bfbf]/50 bg-gradient-to-r from-[#fbf2ed] via-[#fff8f5] to-[#fbf2ed] shrink-0">
          <div className="flex items-center gap-3 w-full overflow-hidden">
            <div className="relative w-10 h-10 rounded-xl bg-white border border-[#e0bfbf]/80 flex items-center justify-center overflow-hidden shadow-xs shrink-0">
              <Image
                src="/images/logo/balc_logo.png"
                alt="Logo"
                fill
            ...
            <div className="flex flex-col justify-center min-w-0">
              <h3 className="text-[9px] font-extrabold text-[#570013] font-['Playfair_Display',serif] leading-tight uppercase tracking-tight truncate">
                ASSOCIATION OF BENGAL
              </h3>
              <span className="inline-flex items-center gap-1 text-[9px] text-[#775a19] uppercase tracking-wider font-bold mt-0.5">
                <Sparkles className="w-2.5 h-2.5 text-amber-600 shrink-0" /> Member Portal
              </span>
            </div>
          </div>
          <button 
            onClick={() => setSidebarOpen(false)}
            className="md:hidden p-1.5 rounded-xl text-[#8c7071] hover:text-[#570013] hover:bg-[#fbf2ed] transition-colors shrink-0 ml-2"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
      ...
      <div className="flex-1 flex flex-col md:ml-72 min-h-screen transition-all">
        ...
        {/* Top Header Bar - Fixed height to match sidebar header and aligned cleanly */}
        <header className="sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-[#e0bfbf]/50 px-6 h-20 flex items-center justify-between shadow-xs">
          <div className="flex items-center gap-3.5">
            <button
              onClick={() => setSidebarOpen(true)}
              className="md:hidden p-2 rounded-xl border border-[#e0bfbf]/80 text-[#570013] bg-[#fbf2ed] hover:bg-[#e0bfbf]/30 transition-colors shadow-xs"
