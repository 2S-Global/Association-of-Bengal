...
export default function LoginPage() {
  ...
  const handleForgotPasswordSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSuccessMessage("Temporary password generated and sent to your email.");
    } catch (error: any) {
          ...
          {!isForgotPassword ? (
            ...
            <>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="text-[11px] font-semibold text-[#775a19] hover:underline outline-none cursor-pointer"
                    >
                      Forgot Password?
                    </button>
                  </div>
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[#8c7071] hover:text-[#570013] transition-colors cursor-pointer"
                    >
                ...
                <button
                  ...
                  className="w-full mt-2 py-3 bg-[#570013] text-white text-xs sm:text-sm font-semibold tracking-wider uppercase rounded-xl hover:bg-[#800020] transition-all shadow-md active:scale-95 flex items-center justify-center gap-2 outline-none disabled:opacity-75 cursor-pointer"
                >
                  {isSubmitting ? (
                    <>
            ...
            <>
              <div className="mb-6 space-y-1">
                ...
                <p className="text-xs text-[#584141]">
                  Enter your registered email address to receive your temporary password.
                </p>
              </div>
              ...
              <form onSubmit={handleForgotPasswordSubmit} className="space-y-4">
                ...
                >
                  {isSubmitting ? (
                    ...
                    <>
                      Send Temporary Password <ArrowRight className="w-4 h-4" />
                    </>
                  )}
                </button>
                ...
                <button
                  ...
                  className="w-full py-2.5 bg-white border border-[#e0bfbf] text-[#584141] text-xs font-semibold rounded-xl hover:bg-[#fbf2ed] transition-all flex items-center justify-center gap-1.5 outline-none shadow-sm cursor-pointer"
                >
