...
import React from "react";
import Image from "next/image";
import kolkataBookFairImage from "../../../../public/images/kolkata_book_fair_1.webp"; // Alternatively: "/images/kolkata_book_fair_1.webp"
...
interface AboutSectionData {
  ...
  highlightedTitle?: string;
  description: string[];
  image: any; // Supports static import or string path
  imageAlt: string;
  stats: AboutStat[];
}
...
const aboutData: AboutSectionData = {
  ...
  // Using the local asset reference
  image: kolkataBookFairImage, 
  // Or simply: image: "/images/kolkata_book_fair_1.webp",
