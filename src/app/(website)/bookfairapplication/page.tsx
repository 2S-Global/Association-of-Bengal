...
export default function BookFairApplicationForm({ fairConfig }: BookFairApplicationFormProps) {
  ...
  return (
    <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-6 lg:py-12 bg-[#fff8f5] text-[#1e1b18] font-['Libre_Franklin'] antialiased selection:bg-[#ffdada] selection:text-[#570013]">
      ...
      {/* Upgraded Professional Middle Popup Modal for Success Message */}
      <div
        className={`${
          isSubmitted ? "flex" : "hidden"
        } fixed inset-0 z-[1000] bg-black/60 backdrop-blur-md items-center justify-center p-4 overflow-y-auto animate-fadeIn`}
      >
        <div className="bg-gradient-to-b from-white via-white to-emerald-50/30 rounded-3xl w-full max-w-lg p-6 sm:p-8 flex flex-col items-center text-center shadow-2xl border-2 border-emerald-500/30 relative my-auto space-y-4">
