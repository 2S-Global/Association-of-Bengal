...
//   // Interactive Date Range Formatter with Today & Past Date Prevention
//   const handleDateSelection = (start: Date | null, end: Date | null) => {
//     const today = new Date();
//     today.setHours(0, 0, 0, 0);

//     if (start && start <= today) {
//       setErrors((prev) => ({ ...prev, date: "Start date must be a future date (today and past dates are not selectable)." }));
//       return;
//     }
...
//       newErrors.date = "Start date must be from tomorrow onwards (today and past dates are not selectable).";
...
//                       setCategory("");
//                     }}
//                     className="text-[11px] font-bold text-[#775a19] hover:underline inline-flex items-center gap-1 cursor-pointer"
//                   >
...
//         {/* Section 2: Library Date Picker with Strict Future Date Enforcement & Venue */}
//         <div>
//           <h2 className="text-xs font-bold text-[#775a19] uppercase tracking-widest mb-4 flex items-center gap-2">
...
//             type="button"
//             onClick={() => router.back()}
//             className="px-6 py-3 rounded-xl border border-[#8c7071] text-[#584141] text-sm font-bold hover:bg-[#fbf2ed] transition-all cursor-pointer"
//           >
//             Cancel
//           </button>
//           <button
...
//             className="px-8 py-3 rounded-xl bg-[#570013] hover:bg-[#800020] text-white text-sm font-bold shadow-md transition-all active:scale-95 inline-flex items-center gap-2 disabled:opacity-50 cursor-pointer"
//           >
//             {isSubmitting ? (
//               <>
